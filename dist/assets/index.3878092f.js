...
`,It=n.div``,jt=t=>({user:t.userState.user}),Ct=t=>({});var Nt=m(jt,Ct)(ft);function Pt(t){const[r,o]=p.exports.useState(!1);return i(At,{children:[e(le,{className:r?"blue":"#000",onClick:()=>{r?(v.collection("linkedin").doc(t.id).update({like:t.like-1}),o(!1)):(v.collection("linkedin").doc(t.id).update({like:t.like+1}),o(!0))}}),i("sub",{children:[" ",t.like," like "]})]})}const At=n.span`
    .blue{
        color:blue !important;
    }
`,Rt=t=>{var h;const[r,o]=p.exports.useState("close"),c=s=>{switch(s.preventDefault(),r){case"open":o("close");break;case"close":o("open");break;default:o("close")}},[a,d]=p.exports.useState([]);return p.exports.useEffect(()=>{v.collection("linkedin").orderBy("date","asc").onSnapshot(s=>{d(s.docs.map(g=>({id:g.id,name:g.data()})))})},[]),console.log(a),i(Tt,{children:[i(Ut,{children:[i("div",{className:"header",children:[e("img",{src:(h=t.user)==null?void 0:h.photoURL}),e("button",{onClick:c,children:"Create a post"})]}),i("div",{children:[i("button",{children:[e(B,{style:{color:"blue"}}),e("span",{children:" Photo "})]}),i("button",{children:[e(ce,{style:{color:"green"}}),e("span",{children:" Video "})]}),i("button",{children:[e(pe,{style:{color:"orange"}}),e("span",{children:" Date "})]}),i("button",{children:[e(he,{style:{color:"pink"}}),e("span",{children:" Write a article "})]})]})]}),e("div",{children:a.map((s,g)=>{var y;return i(Mt,{children:[i(Dt,{children:[i("a",{children:[e(k,{src:s.name.userImg,alt:"Logo"}),i("div",{children:[i("span",{children:[" ",s.name.username," "]}),i("span",{children:[" ",s.name.email," "]}),i("span",{children:[" ",new Date((y=s.name.date)==null?void 0:y.toDate()).toUTCString()," "]})]})]}),e("button",{children:e(ge,{})})]}),i(Et,{children:[" ",s.name.description," "]}),e(Bt,{children:e("a",{children:s.name.postImg?e("img",{src:s.name.postImg,alt:"shared__img"}):e(E,{width:"100%",url:s.name.video})})}),i(Ot,{children:[e("li",{children:e("button",{children:e(Pt,{id:s.id,like:s.name.like})})}),e("li",{children:i("a",{children:[e(xe,{}),i("sub",{children:[" ",s.name.comment," comment "]})]})}),e("li",{children:i("button",{children:[e(ue,{}),e("sub",{children:" Shared "})]})}),e("li",{children:i("button",{children:[e(me,{className:"send__icon"}),e("sub",{children:" Send "})]})})]})]},g)})}),e(Nt,{modal:r,handle:c})]})},Tt=n.div`
    flex:0.6;
    margin:0 20px;
    @media screen and (max-width:768px){
        width:100%;
...
`,Ht=t=>({user:t.userState.user}),Ft=t=>({});var Wt=m(Ht,Ft)(Rt);const Jt=t=>e(Vt,{children:i(Gt,{children:[i(qt,{children:[e("h2",{children:" Add to your feed "}),e(be,{})]}),i(Kt,{children:[i("li",{children:[e("a",{children:e(D,{})}),i("div",{children:[e("span",{children:"#Linkedin"}),e("button",{children:"Follow"})]})]}),i("li",{children:[e("a",{children:e(D,{})}),i("div",{children:[e("span",{children:"#Video"}),e("button",{children:"Follow"})]})]})]}),i(Xt,{children:["View all recomendition",e(we,{style:{color:"blue"}})]}),e(Yt,{})]})}),Vt=n.div`
    flex:0.35;
    @media screen and (max-width:768px){
     width :100% ;
    }
...
`,Zt=t=>{O("Linkedin Home");const r=z();return p.exports.useEffect(()=>{t.user||r("/")},[]),i(b,{children:[e(rt,{}),i(Qt,{children:[i(ei,{children:[e("h3",{children:"Hiring a happy"}),e("p",{children:"Find a talented props time with Upwork and keep business moving"})]}),i(ti,{children:[e(mt,{}),e(Wt,{}),e(Jt,{})]})]})]})},Qt=n.div``,ei=n.section`
        padding-top: 5%;
        max-width: 100%;
...
`,ii=t=>({user:t.userState.user});var ni=m(ii)(Zt);function ri(t){return p.exports.useEffect(()=>{t.getUserAuth()},[]),e(ve,{children:e("div",{className:"app",children:i(ye,{children:[e(U,{exact:!0,path:"/",element:e(qe,{})}),e(U,{exact:!0,path:"/home",element:e(ni,{})})]})})})}const oi=t=>({}),ai=t=>({getUserAuth:()=>t(Te())});var di=m(oi,ai)(ri);const si={user:null},li=(t=si,r)=>{switch(r.type){case H:return A(P({},t),{user:r.user});default:return t}},ci=ke({userState:li}),pi=_e(ci,Se(ze));Le.render(e($e.StrictMode,{children:e(Ie,{store:pi,children:e(di,{})})}),document.getElementById("root"));
